<template>
  <v-tailwind-modal v-model="showPPMod"
            ...
            <div class="container-fluid perevoz_m_bottom">
              <div class="col-12 row">
                <div class="col no_padding_left_form lit_marg_grade">
                  <div class="col-12 create_orders_date_title_1 lit_marg_grade">Марка:</div>
                  <input class="border_input col-12 TS_mod_tip"
                         v-model="marka"/>
                </div>
                <div class="col no_padding_right ">
                  <div class="create_orders_date_title_1 lit_marg_grade col-12">Номер:</div>
                  <input class="border_input col-12 TS_mod_marka"
                         v-model="nomer"/>
                </div>
                <div class="col  no_padding_right">
                  <div class="col-12 create_orders_date_title_1 lit_marg_grade">Длина:</div>
                  ...
                  <div class="col-6">
                    ...
                    <span class="excel_set" v-if="loc_file.file_name" v-on:click="download_modal_file(key)">
                                                    <span class="iconify"
                                                          ...
                                                          style="color: #4d4d4d;" data-width="24"
                                                          data-height="24"></span>
                                                    </span>
                  </div>
                </div>
...
export default {
  props: ['edit_flag', 'gruzootpravitel_id', 'get_gruzootpravitel_list', 'select_gruzootpravitel', 'change_one_gruzzotpravitel', 'addOnePerevozchik', 'vid', 'gradeAddVoditel', 'voditeliComponentAddVoditel', 'gradeAddPPModal'],
  mounted() {
  },
  created() {
  },
  ...
  methods: {
    ...
    save_gruzootpravitel() {
      ...
      axios
          .post('/savePP', {
            PPId: this.current_gruzootpravitel_id,
            marka: this.marka,
            nomer: this.nomer,
            dlina: this.dlina,
            tonn: this.tonn,
