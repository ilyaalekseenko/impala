<template>
  <v-tailwind-modal v-model="showAuthor"
      ...
      <div class="row justify-content-center">
          ...
          <div class="col-12 no_padding_right no_padding_left row mod_borders_bottom">
              ...
              <div class="container-fluid">
                <div class="col-12 row">
                  ...
                  <div class="col-3 date_width_col no_padding_left_form grade_marg_bot">
                    ...
                    <date-picker ref="datepicker0" v-model:value="data_registracii" valueType="format"
                                 format="DD.MM.YYYY" v-model:open="openDP"></date-picker>
              ...
              <div class="container-fluid ">
                <div class="col-12 row" v-for="(oplata,key) in kontakty">
                  ...
                  <button type="button" class="col-1 btn btn-danger btn_del_in_ord1"
                          v-on:click="delete_adres_pogr(key)">-
                  </button>
                </div>
              </div>
            ...
            <div class="col-6">
              ...
              <div class="col-12 "><span v-on:click="dobavit_bank()" class="add_cont_grade">Добавить банковские реквизиты</span>
              </div>
