...
<script>
    export default {
        props: ['vidTsFromParent','key_in_arr','id_ts','zakazchikId'],
        data(){
            return {
                selectedValue: "",
                showList: false,
        ...
        methods: {
            ...
            searchBack(inp)
            {
                ...
                axios
                    .post('/searchBackManager',{
                        searchWord:searchWord,
                        model:'GruzootpravitelContact',
                        fieldToSearch:'FIO',
                        searchOffset:this.searchOffset,
                        zakazchik_id:this.zakazchikId
                    })
                    .then(response => {
            ...
            checkIfVidTSIsset_in_db()
            {
                 ...
                 async function getData(MainVarInInputLOC,zakazchikId) {
                     let res = await axios
                        .post('/getManagerNazvanie', {
                            nazvanie: MainVarInInputLOC,
                            zakazchik_id:zakazchikId
                        })
                     return res.data
                }
                return getData(this.MainVarInInput,this.zakazchikId)
            }
        }
    }
</script>
