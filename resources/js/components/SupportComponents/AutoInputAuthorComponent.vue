                ...
                <ul class="select_list_gruzoot" ref="scrollContainer">
                    <li v-for="(item, index) in filteredList" :key="index">
                        <div v-if="index==0 || item.avtor !== filteredList[index - 1].avtor" class="avtor_gruz row">
                            ...
                            <div class="col-2" v-on:click="show_mod_edit(item.gruzootpravitel_id)" v-b-modal.modal-author variant="primary"> <iconify-icon icon="simple-line-icons:plus" style="color: coral;" width="30" height="30"></iconify-icon></div>
                        </div>
